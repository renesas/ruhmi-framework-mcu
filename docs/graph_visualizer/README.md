...
Download the installation file from [the installation directory](../../install/).  
[The visualizer installation file](../../install/mera_visualizer-2.5.0+mcuv4-py3-none-any.whl)
...
```
# For the reference, assuming the installation file named as mera_visualizer-2.5.0-py3-none-any.whl (Use the whl file you got)
# in the virtual environment on Linux  
pip install mera_visualizer-2.5.0+mcuv3-py4-none-any.whl
...
**Step-2**: Upload a JSON file using drag & drop or paste JSON data directly.  Explanation where to find JSON file is below.
