...
> [!TIP]
> hal_entry.c: Auto-generated example of a possible entry point on Renesas e2 studio project to give the user a starting point on how to run the model. This generated code is intended to be used as a reference by the user.
> It should be helpful to understand how to use the output source code by referring to the following description.
...
Those input and output pointers shall be defined in `model.h` which is generated by the compiler. You shall refer to the definition depending on your model.
