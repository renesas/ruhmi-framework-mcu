...
const TensorInfo sub_0000_tensors[] = {
  ...
  { "serving_default_keras_tensor_91_0", 5, 150528, "INPUT_TENSOR", 0x31000 },
  { "StatefulPartitionedCall_1_0_70088", 0, 1000, "OUTPUT_TENSOR", 0x0 },
};

const size_t sub_0000_tensors_count = sizeof(sub_0000_tensors) / sizeof(sub_0000_tensors[0]);

// Addresses for each input and output buffer inside of the arena
const uint32_t sub_0000_address_serving_default_keras_tensor_91_0 = 0x31000;
const uint32_t sub_0000_address_StatefulPartitionedCall_1_0_70088 = 0x0;
