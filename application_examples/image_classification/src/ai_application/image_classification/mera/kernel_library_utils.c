...
inline int FlatSizeSkipDim(const int* dims, int dims_count, int skip_dim) {
  int flat_size = 1;
...
inline int64_t SignedIntMin(const int64_t a, const int64_t b) {
  return ((a < b) ? a : b);
}

inline int64_t SignedIntMax(const int64_t a, const int64_t b) {
  return ((a > b) ? a : b);
}

//Utility function for Mean
inline uint32_t ReducedOutputOffset(const int num_dims, const int* dims,
...
//Utility function
inline int32_t Offset(const int32_t* dims, int i0, int i1, int i2, int i3) {
...
inline int SubscriptToIndexArr5(const NdArrayDesc desc, const int* indexes) {
...
// Supporting function for Strided Slice op
inline void StridedSlicePadIndices(StridedSliceParams* p, int in_dims, int dim_count) {
  (void)in_dims;
...
// Supporting function for Strided Slice op
inline int StridedSliceStartForAxis(const StridedSliceParams* params, const int32_t* input_shape,
  int32_t axis) {
...
// Supporting function for Strided Slice op
inline int StridedSliceEndForAxis(const StridedSliceParams* params, const int32_t* input_shape,
  int axis, int start) {
...
inline int32_t GetNearestNeighbor(const int input_value, const int32_t input_size, const int32_t output_size,
...
inline void GetPadding(const int32_t* data, int offset, int64_t* left_pad,
                       int64_t* right_pad) {
...
// in input array.
inline int GetFlatIndex(int index, int num_dims,
