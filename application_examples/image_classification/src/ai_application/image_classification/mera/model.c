/*
 * This file is developed by EdgeCortix Inc to be used with Renesas Electronics Hardware.
 *
 * Copyright © 2025 EdgeCortix Inc. Licensed to Renesas Electronics Corporation with the
 * right to sublicense under the Apache License, Version 2.0.
 *
 * This file includes source code originally developed by the Renesas Electronics Corporation.
...
int8_t* GetModelOutputPtr_StatefulPartitionedCall_0_70098() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_StatefulPartitionedCall_0_70098);
}
...
void RunModel(bool clean_outputs) {
  ...
  int8_t* buf_StatefulPartitionedCall_0_70098 = (int8_t*) (sub_0000_arena + sub_0000_address_StatefulPartitionedCall_0_70098);
