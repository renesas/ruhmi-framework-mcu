...
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x3e80,
  .duty_cycle_counts = 0x1f40, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = time_counter_callback,
