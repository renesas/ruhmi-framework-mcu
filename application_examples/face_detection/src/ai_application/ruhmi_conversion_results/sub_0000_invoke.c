...
uint8_t sub_0000_arena[kArenaSize_sub_0000] BSP_ALIGN_VARIABLE(16);
#elif (TENSOR_ARENA_ALLOCATION == ALLOCATE_TO_SDRAM)
uint8_t sub_0000_arena[kArenaSize_sub_0000] BSP_PLACE_IN_SECTION(".sdram") BSP_ALIGN_VARIABLE(16);
#else
