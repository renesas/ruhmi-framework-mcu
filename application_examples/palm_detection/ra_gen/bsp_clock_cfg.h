...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(150,0) /* PLL2 Mul x140-159|Mul x150|PLL2 Mul x150.00 */
#define BSP_CFG_PLL2_FREQUENCY_HZ (1200000000) /* PLL2 1200000000Hz */
...
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (200000000) /* PLL2Q 200000000Hz */
