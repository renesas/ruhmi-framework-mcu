...
{ .ospi_b_unit = 0,
  ...
  .p_autocalibration_preamble_pattern_addr = (uint8_t*) 0x93FFF000,
...
{ .spi_protocol = SPI_FLASH_PROTOCOL_1S_1S_1S, .read_mode = SPI_FLASH_READ_MODE_STANDARD, /* Unused by OSPI_B */
  ...
  .erase_command_list_length = sizeof(g_ospi_b_command_set_initial_erase_commands)
          / sizeof(g_ospi_b_command_set_initial_erase_commands[0]),
  .p_erase_command_list = g_ospi_b_command_set_initial_erase_commands, .p_extend = &g_ospi_b_extended_cfg, };
